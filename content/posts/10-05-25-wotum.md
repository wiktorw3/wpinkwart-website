...
date = 2025-05-10T12:00:00+02:00
type = ["posts","post"]
toc = true
...
{{< image src="/images/wotum/june25_1.png" alt="Wotum App Features" position="center" style="border-radius: 8px; max-width: 100%;" >}}
...
{{< image src="/images/wotum/wotum_event_image.png" alt="Wotum Launch Event" position="center" style="border-radius: 8px; max-width: 100%;" >}}
...
{{< image src="/images/wotum/wotum_appstore_Image.png" alt="Wotum #3 in App Store News Category" position="center" style="border-radius: 8px; max-width: 100%;" >}}
...
## Why the product approach mattered

Most existing political tools focus on content or commentary. Wotum focused on **structure**.

The guiding idea was closer to how sports or finance apps work:

* follow entities over time (candidates, parties)
* see changes and trends, not just snapshots
* surface relevant updates automatically
* link raw data to context

Mobile worked well for this because it supports short, frequent check-ins and timely updates — but the core idea was about product design, not the device itself.

I still believe this approach makes Wotum a distinct offering, even compared to strong web-based projects.

{{< image src="/images/wotum/june25_3.png" alt="Wotum Product Approach" position="center" style="border-radius: 8px; max-width: 100%;" >}}
...
{{< image src="/images/wotum/june25_5.png" alt="Wotum Future Roadmap" position="center" style="border-radius: 8px; max-width: 100%;" >}}
